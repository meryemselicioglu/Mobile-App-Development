...
public class ArticleDownloadRunnable implements Runnable {
    ...
    private static final String yourAPIKey ="ec662082c6e043eba42455b9be345a63";
    ...
    private ArrayList<NewsSource> parseSource(String s){
        ...
        try {
            ...
            for (int i =0; i<jSources.length(); i++){
                ...
                sourceArrayList.add(new NewsSource(id,name,category));
            }
    ...
    public Drawable retrieveImgFromWeb(String url) {
        try {
            ...
            return Drawable.createFromStream(is, "article image");
        } catch (Exception e) {
